...
INSERT INTO Clientes VALUES (1,'John');
...
INSERT INTO Productos VALUES( 1, 'Camisa');
...
INSERT INTO DetallesPedido VALUES( 1, 1);
...
SELECT C.nombre, P.id FROM Clientes AS C
...
SELECT P.nombre, DP.pedido_id FROM Productos AS P
